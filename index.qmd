...
## Custom skills {.smaller}

You can add your own skills at two levels:

- **User-level** — `~/.posit/assistant/skills/{skill-name}/` — available across all projects
- **Project-level** — `.posit/assistant/skills/{skill-name}/` in your project root — scoped to one project
...
## Posit Assistant suggests next steps
